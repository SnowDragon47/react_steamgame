    ...
    return (
      <div>
        ...
        <div className="container" style={{zIndex:2, position:"relative"}}>
          <div className="grid lg:grid-cols-12 sm:grid-cols-12 ssm:grid-rows-12 -my-[15%] lg:h-[1200px] sm:h-[2400px] ssm:h-[2400px]">
            <div className="lg:col-span-9 sm:col-span-9 ssm:row-span-4 lg:w-[70%] sm:w-[70%] ssm:w-[27%] -ml-6 lg:mt-0 sm:mt-[1080px] ssm:mt-[1080px] lg:mx-0 sm:mx-12 ssm:mx-2">
            ...
            <div className="lg:col-span-3 sm:col-span-3 ssm:row-span-5 lg:w-[360px] sm:w-[360px] ssm:w-[360px] lg:mt-0 sm:-mt-[800px] ssm:-mt-[800px] lg:-mx-[30px] sm:mx-[35%] ssm:mx-[2%]">
              <img src={ContentHeader} alt="" className="featured_header"/>
